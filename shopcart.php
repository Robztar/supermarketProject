...
<head>
     ...
     <title>Fresh Mart | Cart Page</title>
          ...
          <ul class="navbar-nav ml-auto">
               ...
               <li class="nav-item">
                    <a class="nav-link" href="./contact.php">
                         <i class="fas fa-mobile-alt mr-2"></i>Contact US
                    </a>
               </li>
               <li class="nav-item">
               ...
               <li class="nav-item">
                    <a class="nav-link active" href="./shopcart.php">
     ...
     echo $_SESSION['message'];
          ...
          <table class="table table-bordered table-striped text-center">
               ...
               <tr>
                    ...
                    <th>Total Price</th>
                    <th>
                    <a href="./controller/action.php?clear=all" class="badge-danger badge p-1" onclick="return confirm('Are you sure want to clear your cart?');"><i class="fas fa-trash"></i>&nbsp;&nbsp;Clear Cart</a>
                    </th>
               </tr>
               </thead>
               <tbody>
               ...
               <tr>
                    ...
                    <td>
                    <a href="./controller/action.php?remove=<?= $row['id'] ?>" class="text-danger lead" onclick="return confirm('Are you sure want to remove this item?');"><i class="fas fa-trash-alt"></i></a>
                    </td>
               </tr>

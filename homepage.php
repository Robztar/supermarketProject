...
body{
  ...
  <nav class="navbar navbar-expand-md fixed-top bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link active" href="./homepage.php">Products</a>
        </li>
        <li class="nav-item">
  ...
  <div class="parallax">
	<div class="page-title"><b><h1>Products</h1></b></div>
	</div>
  <!-- Navbar end -->
  ...
  <div class="container">
    ...
    <div class="row mt-2 pb-3">
      <?php
  		  include './controller/dbh-cart.php';
  ...
  <footer class="footer mt-auto py-3 bg-dark">
    ...
    <span class="text-muted">Copyright &copy 2021. Internet Authoring Group 1. All Rights Reserved.</span>
